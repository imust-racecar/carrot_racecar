  ...
  produce_time_sign();  
     ...
     if( ms_10flag)
     {
      gpio_turn(PTB1);
        ...
        uart_putchar(((UART_Type *)(0x4006A000u)),(char)(motor.count/127));
        uart_putchar(((UART_Type *)(0x4006A000u)),(char)(motor.count%127)); 
        ...
        watch_dog --;
          ...
          if(watch_dog <= 0){
            ...
            uart_rx_irq_en(((UART_Type *)(0x4006A000u)));
          }
        }
       
        turn_deal();
        ftm_pwm_duty(((FTM_Type *)(0x40039000u)),FTM_CH0,out_pwm);  
...
void turn_deal(void)
{
  ...
  if(madata.fill_cnt >= 5)
  {
   ...
   ftm_pwm_duty(((FTM_Type *)(0x40038000u)),FTM_CH0,turn);
}  
char data1[5] = {0};
void uart0_irq(void)
{
  ...
  watch_dog = 50;
  uart_getchar(((UART_Type *)(0x4006A000u)),&ch);
