...
void  motor_control(Motor_pid_data *motor,SPEED_STATE *speed)
{
 ...
 motor->Integral_MIN=-4000;
  ...
  if(motor->spe_nI>motor->Integral_MAX)
   ...
   if(motor->output>=0)
   {
     ftm_pwm_duty(((FTM_Type *)(0x40038000u)),FTM_CH1,motor->output);    
     ftm_pwm_duty(((FTM_Type *)(0x40038000u)),FTM_CH0,0);
   }
...
void average_wave_filtering(Motor_pid_data *motor)
{       
   motor->count = ftm_pulse_get(((FTM_Type *)(0x4003A000u)));   
   ftm_clean(((FTM_Type *)(0x4003A000u)));                
}
