...
if("TRUE" STREQUAL "TRUE")
  set(rf2o_laser_odometry_SOURCE_PREFIX /home/r3v334/carrot_racecar/src/rf2o_laser_odometry)
  set(rf2o_laser_odometry_DEVEL_PREFIX /home/r3v334/carrot_racecar/devel)
  ...
  set(rf2o_laser_odometry_INSTALL_PREFIX /home/r3v334/carrot_racecar/install)
...
if(NOT "/home/r3v334/carrot_racecar/src/rf2o_laser_odometry/include " STREQUAL " ")
  set(rf2o_laser_odometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/r3v334/carrot_racecar/src/rf2o_laser_odometry/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/r3v334/carrot_racecar/src/rf2o_laser_odometry/${idir}'.  ${_report}")
    endif()
